...
export const ShimmerButton = React.forwardRef((
  ...
  return (
    <button
      ...
      className={cn(
        "group shadow-md shadow-neutral-300/20  relative z-0 flex gap-2 cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-5 py-2 text-white [background:var(--bg)] [border-radius:var(--radius)] dark:text-slate-50",
